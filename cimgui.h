...
//based on imgui.h file version "1.92.0 WIP" 19199 from Dear ImGui https://github.com/ocornut/imgui
...
typedef enum {
    ImFontFlags_None                    = 0,
    ImFontFlags_DefaultToLegacySize     = 1 << 0,
...
typedef ImU16 ImGuiTableDrawChannelIdx;extern  ImGuiContext* GImGui;typedef FILE* ImFileHandle;
...
CIMGUI_API void igPushFont(ImFont* font,float font_size_base);
CIMGUI_API void igPopFont(void);
CIMGUI_API void igPushFontSize(float font_size_base);
